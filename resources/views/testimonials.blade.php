...
<head>
  ...
  <title>Testimonials — Trackly</title>
  <meta name="description" content="Client feedback from the sales and marketing teams that use Trackly every day.">
  <meta property="og:type" content="website">
  <meta property="og:title" content="Testimonials — Trackly">
  <meta property="og:description" content="Client feedback from the sales and marketing teams that use Trackly every day.">
...
<body>
  ...
  <main>
    <section class="page-hero">
      <div class="container">
        <nav class="crumbs" aria-label="Breadcrumb"><a href="{{ route('home') }}">Home</a><span>/</span><span aria-current="page">Testimonials</span></nav>
        <p class="tag">Social proof</p>
        <h1>Hear From Our Clients Who Achieved Real Success</h1>
        <p class="page-hero-sub">Genuine feedback from the teams we work with every week.</p>
      </div>
    </section>
      ...
      <div class="container">
        <div class="tcard-grid">
          <figure class="tcard reveal">
            <div class="stars" aria-label="Rated 5 out of 5"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"></div>
            <blockquote>This platform completely transformed our sales strategy. Our conversions increased by 40% in just six months!</blockquote>
            <figcaption>
              <img src="images/RZI4qqw0FEql.webp" alt="" width="48" height="48" loading="lazy">
              <span><strong>John Smith</strong><small>CEO of TechNova</small></span>
            </figcaption>
          </figure>
          <figure class="tcard reveal">
            <div class="stars" aria-label="Rated 5 out of 5"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"></div>
            <blockquote>We finally have one number the whole company agrees on. That alone ended a year of arguing in meetings.</blockquote>
            <figcaption>
              <img src="images/oeNPPkgNr9OD.webp" alt="" width="48" height="48" loading="lazy">
              <span><strong>Amelia Carter</strong><small>Head of Growth, Brightwave</small></span>
            </figcaption>
          </figure>
          <figure class="tcard reveal">
            <div class="stars" aria-label="Rated 5 out of 5"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"></div>
            <blockquote>Our reps stopped exporting spreadsheets. Nineteen days came off the average sales cycle in one quarter.</blockquote>
            <figcaption>
              <img src="images/ICNfenU3ejW6.webp" alt="" width="48" height="48" loading="lazy">
              <span><strong>Daniel Reyes</strong><small>Sales Director, Orbit Logistics</small></span>
            </figcaption>
          </figure>
          <figure class="tcard reveal">
            <div class="stars" aria-label="Rated 5 out of 5"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"></div>
            <blockquote>The localized campaign plan was the first thing that actually worked in markets where nobody knew us.</blockquote>
            <figcaption>
              <img src="images/Cb7Orz3gSlbl.webp" alt="" width="48" height="48" loading="lazy">
              <span><strong>Priya Nair</strong><small>CMO, NexGen Solutions</small></span>
            </figcaption>
          </figure>
          <figure class="tcard reveal">
            <div class="stars" aria-label="Rated 5 out of 5"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"></div>
            <blockquote>Inbound demo requests tripled without spending another dollar on ads. The content plan paid for itself.</blockquote>
            <figcaption>
              <img src="images/ZByiE2jPSsSe.webp" alt="" width="48" height="48" loading="lazy">
              <span><strong>Marcus Lee</strong><small>Founder, Northline Finance</small></span>
            </figcaption>
          </figure>
          <figure class="tcard reveal">
            <div class="stars" aria-label="Rated 5 out of 5"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"></div>
            <blockquote>Onboarding took nine days. I had expected a quarter of disruption and it never came.</blockquote>
            <figcaption>
              <img src="images/me8K3xfzphza.webp" alt="" width="48" height="48" loading="lazy">
              <span><strong>Mei Tanaka</strong><small>Marketing Lead, Kasa Studio</small></span>
            </figcaption>
          </figure>
          <figure class="tcard reveal">
            <div class="stars" aria-label="Rated 5 out of 5"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"></div>
            <blockquote>The weekly review format is deceptively simple and it caught a pipeline problem two months early.</blockquote>
            <figcaption>
              <img src="images/Di2BEsKPzkIK.webp" alt="" width="48" height="48" loading="lazy">
              <span><strong>Ethan Brooks</strong><small>COO, Harborlight</small></span>
            </figcaption>
          </figure>
          <figure class="tcard reveal">
            <div class="stars" aria-label="Rated 5 out of 5"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"><img src="images/GGrQHdf01eSm.webp" alt="" width="18" height="18" loading="lazy"></div>
            <blockquote>Support answers in hours, not days, and they know our setup. That is rarer than it should be.</blockquote>
            <figcaption>
              <img src="images/TOvOclWMKXJF.webp" alt="" width="48" height="48" loading="lazy">
              <span><strong>Lucas Moreau</strong><small>VP Sales, Verdi Group</small></span>
            </figcaption>
          </figure>
        </div>
      </div>
